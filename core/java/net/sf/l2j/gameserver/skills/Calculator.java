 ...
 * In fact, each calculator is a table of Func object in which each Func represents a mathematical function : <BR><BR>
 * 
...
public final class Calculator 
{
	...
	private final Func[] _emptyFuncs = new Func[0]; 
